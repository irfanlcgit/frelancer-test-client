...
export default class TimeCard extends Component {
  ...
  handleSubmitEmail = async event => {
    ...
    if(this.state.SubmitEmailValid && this.state.SubmitEmail.length > 0){
      ...
      var key = 'documents/'+new Date().getTime()+'-'+file_name;
...
<form className="form-horizontal">
  ...
  <div className="form-group">
    ...
    <div className="col-xs-8">
      <TimePicker inputReadOnly={this.state.inputReadOnly} allowEmpty={this.state.allowEmpty} value={this.state.DayTimeTravel2} format={this.state.format} onChange={this.handleChangeDayTimeTravel2.bind(this)}/>
    </div>
  </div>
  :""}
  ...
  <div className="form-group">
    ...
    <div className="col-xs-8">
      <TimePicker inputReadOnly={this.state.inputReadOnly} allowEmpty={this.state.allowEmpty} value={this.state.DayTimeStart} format={this.state.format} onChange={this.handleChangeDayTimeStart.bind(this)}/>
    </div>
  </div>
  ...
  <div className="form-group">
    ...
    <div className="col-xs-7">
      ...
      <TimePicker inputReadOnly={this.state.inputReadOnly} allowEmpty={this.state.allowEmpty} value={this.state.DayTimeTotalMBDed} format={this.state.format} onChange={this.handleChangeDayTimeTotalMBDed.bind(this)} disabled={this.state.TotalMBDedDisabled} />
  ...
  <div className="form-group">
    ...
    <div className="col-xs-8">
      <TimePicker inputReadOnly={this.state.inputReadOnly} allowEmpty={this.state.allowEmpty} value={this.state.DayTimeFinish} format={this.state.format} onChange={this.handleChangeDayTimeFinish.bind(this)}/>
    </div>
  </div>
  ...
  <div className="form-group">
    ...
    <div className="col-xs-8">
      <TimePicker inputReadOnly={this.state.inputReadOnly} allowEmpty={this.state.allowEmpty} value={this.state.DayTimeTravel1} format={this.state.format}  onChange={this.handleChangeDayTimeTravel1.bind(this)}/>
    </div>
  </div>
  : ""}
...
<form className="form-horizontal">
  ...
  <div className="form-group">
    ...
    <div className="col-xs-8">
      <TimePicker inputReadOnly={this.state.inputReadOnly} allowEmpty={this.state.allowEmpty} value={this.state.DayTimeStartMeal} format={this.state.format} onChange={this.handleChangeDayTimeStartMeal.bind(this)}/>
    </div>
  </div>
  ...
  <div className="form-group">
    ...
    <div className="col-xs-8">
      <TimePicker inputReadOnly={this.state.inputReadOnly} allowEmpty={this.state.allowEmpty} value={this.state.DayTimeFinishMeal1} format={this.state.format} onChange={this.handleChangeDayTimeFinishMeal1.bind(this)}/>
    </div>
  </div>
  ...
  <div className="form-group">
    ...
    <div className="col-xs-8">
      <TimePicker inputReadOnly={this.state.inputReadOnly} allowEmpty={this.state.allowEmpty} value={this.state.DayTimeStartMeal2} format={this.state.format} onChange={this.handleChangeDayTimeStartMeal2.bind(this)}/>
    </div>
  </div>
  ...
  <div className="form-group">
    ...
    <div className="col-xs-8">
      <TimePicker inputReadOnly={this.state.inputReadOnly} allowEmpty={this.state.allowEmpty} value={this.state.DayTimeFinishMeal2} format={this.state.format} onChange={this.handleChangeDayTimeFinishMeal2.bind(this)}/>
    </div>
  </div>
  ...
  <div className="form-group">
    ...
    <div className="col-xs-8">
    <TimePicker inputReadOnly={this.state.inputReadOnly} allowEmpty={this.state.allowEmpty} value={this.state.DayTimeStartMeal3} format={this.state.format} onChange={this.handleChangeDayTimeStartMeal3.bind(this)}/>
    </div>
  </div>
  ...
  <div className="form-group">
    ...
    <div className="col-xs-8">
      <TimePicker inputReadOnly={this.state.inputReadOnly} allowEmpty={this.state.allowEmpty} value={this.state.DayTimeFinishMeal3} format={this.state.format} onChange={this.handleChangeDayTimeFinishMeal3.bind(this)}/>
    </div>
  </div>
...
<div className="modal-dialog modal-dialog-centered timecard_2popup" role="document">
  ...
  <div className="form-group">
    ...
    <div className="col-sm-8">
      ...
      <TimePicker inputReadOnly={this.state.inputReadOnly} allowEmpty={this.state.allowEmpty} value={this.state.DayTimeFinishMeal2} format={this.state.format} onChange={this.handleChangeDayTimeFinishMeal2.bind(this)}/></div>
  </div>
  <div className="form-group">
  ...
  <div className="form-group">
    ...
    <div className="col-sm-8">
      ...
      <TimePicker inputReadOnly={this.state.inputReadOnly} allowEmpty={this.state.allowEmpty} value={this.state.DayTimeFinishMeal3} format={this.state.format} onChange={this.handleChangeDayTimeFinishMeal3.bind(this)}/></div>
  </div>
