...
export default class SignatureSettings extends Component {
	...
	async componentDidMount() {
	  /*try {
		...
		Storage.vault.get('SignatureFile.png', {level: 'private'})
		    .then(result => {
	...
	saveSignature = async event => {
		...
		//console.log(type);
		Storage.vault.put('SignatureFile.png', base64Data, { contentType: 'image/png' })
  		.then (result => {
				...
				<div className="tabbable-line">
					...
					<div className="tab-content">
						<div className="tab-pane active" id="tab_default_1">
							...
							<p><img src={this.state.SignatureImage} alt="" onError={this.handleImageError} /></p>
							<p></p>
					  	</div>
