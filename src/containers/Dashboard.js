...
export default class Dashboard extends Component {
	...
	render()
	{
		...
		<div className="modal fade" id="profileModal" tabIndex="-1" role="dialog" aria-labelledby="profileModalTitle" aria-hidden="true" style={{display: "none"}}>
					...
					<div className="modal-body register_suc register_popup">
						...
						<div className="col-sm-4 p0">
							...
							<div className="btn_cance_save">
								...
								<input name="" type="button" className="btn_cancel_pro" value="Cancel" data-dismiss="modal"/>
							</div>
						</div>
		...
		<div className="modal fade" id="changePasswordModal" tabIndex="-1" role="dialog" aria-labelledby="changePasswordModalTitle" aria-hidden="true" style={{display: "none"}}>
			<div className="modal-dialog modal-dialog-centered modla_edit_profile" role="document">
					...
					<div className="modal-body register_suc register_popup forgotPasswordPopupBody">
						<div className="forgot_box forgotPasswordBoxContainer">
							...
							<div className="register_box_mid register_box_mid2">
								...
								<form>
									<div className="col-sm-12 p0">
										<input name="" id="username" className="frogot_input forgotPasswordInput" type="text" placeholder="Email Address"/>
									...
									<button class="btn_forogot btn_forogot_new"  data-dismiss="modal" data-toggle="modal" data-target="#changePasswordPinCodeModal">Proceed</button>
								</form>
								<div className="clear10"></div>
							</div>
						</div>
		...
		<div className="modal fade" id="changePasswordPinCodeModal" tabIndex="-1" role="dialog" aria-labelledby="changePasswordModalTitle" aria-hidden="true" style={{display: "none"}}>
			<div className="modal-dialog modal-dialog-centered modla_edit_profile" role="document">
				<div className="modal-content forgotPasswordModalContent">
					<div className="modal-header modal_header_register">
						<button type="button" className="close" data-dismiss="modal" aria-label="Close">
					...
					<div className="modal-body register_suc register_popup forgotPasswordPopupBody">
						<div className="forgot_box forgotPasswordBoxContainer">
							...
							<div className="register_box_mid register_box_mid2">
								...
								<form>
									<div className="col-sm-12 p0">
										<input name="" id="username" className="frogot_input forgotPasswordInput" type="text" placeholder="Pin Code"/>
										<img src="images/ic_vpn_key_24px.svg" width="15px" height="15px" className="register_icon1 forgotPasswordEmailIcon" alt="" />
									</div>
									<div className="clear30"></div>
									{/*<a href="/forgot_code" className="btn_forogot">Proceed</a>*/}
									<button class="btn_forogot btn_forogot_new"  data-dismiss="modal" data-toggle="modal" data-target="#changePasswordFieldsCodeModal">Proceed</button>
								</form>
								<div className="clear10"></div>
							</div>
						</div>
		...
		<div className="modal fade" id="changePasswordFieldsCodeModal" tabIndex="-1" role="dialog" aria-labelledby="changePasswordModalTitle" aria-hidden="true" style={{display: "none"}}>
			<div className="modal-dialog modal-dialog-centered modla_edit_profile" role="document">
				<div className="modal-content forgotPasswordModalContent">
					<div className="modal-header modal_header_register">
						<button type="button" className="close" data-dismiss="modal" aria-label="Close">
					...
					<div className="modal-body register_suc register_popup forgotPasswordPopupBody">
						<div className="forgot_box forgotPasswordBoxContainer">
							...
							<div className="register_box_mid register_box_mid2">
								...
								<form>
									<div className="col-sm-12 p0">
										<input name="" id="password" className="frogot_input forgotPasswordInput" type="password" placeholder="Password"/>
										<img src="images/ic_lock_outline_24px.svg" width="15px" height="15px" className="register_icon1 forgotPasswordEmailIcon" alt="" />
									</div>
									<div className="clear10"></div>
									<div className="col-sm-12 p0">
										<input name="" id="confirmpassword" className="frogot_input forgotPasswordInput" type="password" placeholder="Confirm Password"/>
										<img src="images/ic_lock_outline_24px.svg" width="15px" height="15px" className="register_icon1 forgotPasswordEmailIcon" alt="" />
									</div>
									<div className="clear30"></div>
									{/*<a href="/forgot_code" className="btn_forogot">Proceed</a>*/}
									<button class="btn_forogot btn_forogot_new"  data-dismiss="modal" data-toggle="modal" data-target="#changePasswordSuccessModal">Change Password</button>
								</form>
								<div className="clear10"></div>
							</div>
						</div>
		...
		<div className="modal fade" id="changePasswordSuccessModal" tabIndex={-1} role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div className="modal-dialog modal-dialog-centered modla_register" role="document">
          <div className="modal-content">
            ...
            <div className="modal-body register_suc register_popup">
              ...
              <div className="clearfix" />
              <button class="btn_forogot btn_forogot_new"  data-dismiss="modal">Ok</button>
            </div>
          </div>
        </div>
      </div>
