...
export default class Privacy extends Component {
	...
	render()
	{
        ...
        <div className="col-sm-12 p0">
          <div className="col-xs-12  col-sm-12 col-md-12 pull-right mrg_dashboard_right">
            <div className="clear40" />
            <div className="col-xs-12 col-sm-12 col-md-12 col-md-offset-1 time_table_mrg">
              ...
              <div className="privacy_policy">
                ...
                <p>If you have any questions or suggestions about [my|our] Privacy Policy, do not hesitate to contact
                  [me|us].</p>
                <p>This Privacy Policy page was created at <a href="#" target="_blank">freelanceportal.com</a>.</p>
              </div>
              <div className="clear10" />
            </div>
            <div className="col-xs-12 col-sm-12 col-md-10 col-md-offset-1 time_table_mrg_res">
              <div className="res_top_timecard">
                <div className="col-xs-12 text-center">Privacy Policy</div>
              </div>
              <div className="clear10" />
