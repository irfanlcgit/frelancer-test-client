...
//                       		echo date('Y-m-01');
                        ...
                        <tr>
                          ...
                          <td class="disable_date">
                            <span class="dated">02</span>
                            <div class="clear20"></div>
                            <span>$ 77</span>
                          </td>
                          <td class="disable_date">
                            <span class="dated">03</span>
                            <div class="clear20"></div>
                            <span>$ 77</span>
                          </td>
                          <td class="disable_date">
                            <span class="dated">04</span>
                            <div class="clear20"></div>
                            <span>$ 77</span>
                          </td>
                          <td class="disable_date">
                            <span class="dated">05</span>
                            <div class="clear20"></div>
                            <span>$ 77</span>
                          </td>
                          <td class="disable_date">
...
console.log(daysInMonth(currentMonthNum,currentYear));
console.log("daysInMonth(currentMonthNum,currentYear)");
